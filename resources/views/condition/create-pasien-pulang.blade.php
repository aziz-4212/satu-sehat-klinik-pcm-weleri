...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Condition Pasien Meninggalkan Faskes</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="">Condition Pasien Meninggalkan Faskes</a></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-teal">
                    <h3 class="card-title text-white">Condition Pasien Meninggalkan Faskes</h3>
                </div>
                <div class="card-body">
                    <form method="GET" action="{{ route('condition.create-pasien-pulang') }}">
                        @csrf
                        <div class="row">
                            <div class="col-3">
                    ...
                    <form method="POST" action="{{ route('condition.store-pasien-pulang') }}">
                        @csrf
                        <button type="submit" class="btn bg-teal">Kirim Data</button>
                ...
                {{ $diagnosis->links('layouts.partials.pagination') }}
            </div>
