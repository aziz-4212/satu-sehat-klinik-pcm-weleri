...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="">Observation</a></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <a href="{{route('observation.index')}}" style="width: 120px" class="btn bg-teal mb-1"> <i class="fas fa-arrow-left"></i> Kembali</a>
            <div class="card">
                <div class="card-header bg-teal">
                    <h3 class="card-title text-white">Observation</h3>
                </div>
                <div class="card-body">
                    <form method="GET" action="{{ route('observation.create') }}">
                        @csrf
                        <div class="row">
                            <div class="col-3">
                    ...
                    <form method="POST" action="{{ route('observation.store') }}">
                        @csrf
                        <button type="submit" class="btn bg-teal">Kirim Data Observation</button>
