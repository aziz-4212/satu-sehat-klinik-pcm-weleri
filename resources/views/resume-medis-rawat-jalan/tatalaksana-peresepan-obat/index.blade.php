...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tatalaksana - Peresepan Obat (MedicationRequest)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="">Tatalaksana - Peresepan Obat (MedicationRequest)</a></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-teal">
                    <h3 class="card-title text-white">Tatalaksana - Peresepan Obat (MedicationRequest)</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-3">
