...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Hasil Pemeriksaan Fisik (Observation)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="">Hasil Pemeriksaan Fisik (Observation)</a></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <form method="GET" action="{{ route('resume-medis-rawat-jalan.hasil-pemeriksaan-fisik.index') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-3">
                            ...
                            <form method="POST" action="{{ route('resume-medis-rawat-jalan.hasil-pemeriksaan-fisik.store') }}">
                                @csrf
