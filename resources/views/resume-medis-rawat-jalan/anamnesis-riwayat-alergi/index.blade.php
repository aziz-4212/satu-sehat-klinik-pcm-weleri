...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Anamnesis - Riwayat Alergi (Allergy Intolerance)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="">Anamnesis - Riwayat Alergi (Allergy Intolerance)</a></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-teal">
                    <h3 class="card-title text-white">Anamnesis - Riwayat Alergi (Allergy Intolerance)</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col-9">
                            {{-- <form method="GET" action="{{ route('resume-medis-rawat-jalan.riwayat-alergi.index') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-3">
                            ...
                            {{-- <form method="POST" action="{{ route('resume-medis-rawat-jalan.riwayat-alergi.store') }}">
                                @csrf
