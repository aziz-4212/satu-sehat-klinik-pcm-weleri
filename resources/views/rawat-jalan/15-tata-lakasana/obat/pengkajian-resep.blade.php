...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Pengkajian Resep (QuestionnaireResponse)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Pengkajian Resep (QuestionnaireResponse)</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-teal d-flex justify-content-between align-items-center">
                    <h3 class="card-title text-white">Pengkajian Resep (QuestionnaireResponse)</h3>
                    <div class="ml-auto">
                        ...
                        @else
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th>Questionnaire Response ID</th>
                                    <th>Tanggal Jam</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->id_questionnaire_response }}</td>
                                        <td>{{ \Carbon\Carbon::parse($item->created_at)->translatedFormat('d F Y H:i:s') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
