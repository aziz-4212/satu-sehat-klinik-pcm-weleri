            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('rawat-jalan.pendaftaran-kunjungan-rawat-jalan.menu')}}">Pendaftaran Kunjungan Rawat Jalan</a></li>
                        <li class="breadcrumb-item"><a href="">Masuk Ruang</a></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-teal d-flex justify-content-between align-items-center">
                    <h3 class="card-title text-white">Kunjungan Baru</h3>
                    <div class="ml-auto">
