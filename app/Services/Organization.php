...
class Organization
{
    ...
    public function search_part_of($part_of)
    {
        ...
        CURLOPT_URL => $this->url->base_url.'/Organization?partof='.$part_of,
    ...
    public function create($mapping_organization)
    {
        $curl = curl_init();
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_POSTFIELDS =>'{
                ...
                "identifier": [
                    {
                        ...
                        "value": "'.$mapping_organization->koders.'"
                    }
                ],
                "type": [
                    {
                ...
                "name": "'.$mapping_organization->deskripsi.'",
                "telecom": [
                    {
                        "system": "phone",
                        "value": "(0294) 641870",
