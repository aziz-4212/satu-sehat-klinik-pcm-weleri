...
use App\Services\AllergyIntolerance;
...
class AllergyIntoleranceController extends Controller
{
    public function __construct()
    {
        ...
        $this->allergy_intolerance = new AllergyIntolerance;
    }

    public function index(Request $request){
        if (isset($request->id)) {
            $data = $this->allergy_intolerance->search_by_id($request->id);
            $id = isset($request->id);
            $mode_search = "id";
        }else {
            $data = null;
        ...
        return view('allergy-intolerance.index', compact('data', 'id', 'mode_search'));
    }
    ...
    public function create(Request $request){
        ...
        return view('allergy-intolerance.create', compact('mapping_kunjungan_poli'));
    }
